    ...
    <div class="row">
      <article class="section-n1__about link-animation">
        <header class="page-header">
          <h1>CRIAÇÃO DE SITE RESPONSIVO</h1>
          <h2>Invista no crescimento da sua empresa</h2>
        </header>
        <div class="section-n1__content">
          <p>Criação de site para empresas que procuram soluções para vender mais na internet através de um formato cuidadosamente desenvolvido pela Intrust Web, garantindo em sua tecnologia o desenvolvimento leve, com design inovador, respeitando as normas que um site responsivo precisa e práticas para garantir a conversão e atração de mais clientes (Leads) para o seu negócio.</p>
        </div>
...
<div class="row">
  ...
  <div class="tab-content">
    ...
    <article role="tabpanel" class="tab-pane fade" id="tab-pane3">
      ...
      <div class="col-xs-12 text-center">
        <!-- <a target="_blank" href="http://kurc.com.br/" class="href btn btn-custom1">VER SITE  </a> -->
      </div>
    </article>
...
<section id="products" class="section-n4">
  <div class="container">
    <div class="row">
      <header class="page-header">
        <h1>Porque criar um site</h1>
        <h2>Motivos para fazer site com a Intrust Web</h2>
      </header>
    </div><!-- row -->
  </div><!-- container -->
</section><!-- section-n4 -->
  ...
  <div class="container">
    <div class="row">
      <article class="col-xs-12 col-sm-4">
        ...
        <p>Criação de site com 30 dias de desenvolvimento. Mas se precisar, temos formato para 7 dias.</p>
      </article>
      <article class="col-xs-12 col-sm-4">
        <div class="wrapper-icons"><span class="icons icon-mobile3"></span></div><br>
        <strong>RESPONSIVO</strong><br>
        <p>Site responsivo para mobile, garantindo a visibilidade para todos os usuários e os resultados da buscas através de dispositivos mobile.
</p>
      </article>
      <article class="col-xs-12 col-sm-4">
    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-8 col-md-7 pull-right orcamento">
        <div class="col-xs-12 col-sm-5 no-gutter">
          <h1>Compre seu site agora a partir de:</h1>
        </div>
  ...
  <div class="container">
    <div class="row">
      <div class="col-xs-12 col-sm-3">
        ...
        <strong class="count">+</strong><strong class="count timer" data-from="0" data-to="150">0</strong><br>
        <strong class="textCount">Sites<br>Entregues</strong>
      </div>
      <div class="col-xs-12 col-sm-3">
...
<section id="contact" class="section-n6">
  <div class="container no-gutter">
    <div class="row">
      <header class="page-header">
        <h1>FALE CONOSCO</h1>
        <h2>Não perca mais tempo e dinheiro em outras tentativas, faça o seu site com a Intrust Web agora!</h2>
      </header>
    </div><!-- row -->
