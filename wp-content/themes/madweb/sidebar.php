<aside class="col-xs-12 col-sm-3">
	...
	<div class="sidebar newsletter newsletter2">
		<header><h1>Quer saber como atrair clientes e vender mais?</h1></header>
		<strong>Insira o seu endereço de email abaixo e aprenda conosco!</strong><br>
		<div class="iconsAnimated animated bounce infinite">
		...
		<form action="https://formspree.io/ricardo.rocha@madgo.com.br" method="POST">
			...
			<div class="input-group">
				<input type="email" placeholder="Seu e-mail" name="E-mail" required>
			</div>
